...
(function () {
  ...
  var renderMapMark = function (adsOffer) {
    ...
    mapMarkElement.querySelector('.popup__type').textContent = APPARTMENT_TYPES[adsOffer.offer.type];
    ...
    adsOffer.offer.photos.forEach(function (photo) {
      photosNew.push('<img src="' + photo + '" class="popup__photo" width="45" height="40" alt="Фотография жилья">');
    });
